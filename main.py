...
async def main():
    ...
    scheduler.add_job(handlers.check_pair_and_send_message, trigger='cron', hour=22, minute=56, kwargs={'bot': bot})
    ...
    scheduler.add_job(handlers.check_pair_and_send_message, trigger='cron', hour=19, minute=55, kwargs={'bot': bot})
    scheduler.add_job(requests.forced_closure, trigger='cron', hour=22, minute=0)
    scheduler.start()
