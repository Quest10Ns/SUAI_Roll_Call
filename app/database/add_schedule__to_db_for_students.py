...
# =================================================================================================================== #
# Если у вас возникает ошибка связанная с PermissionError: [Errno 13] Permission denied: 'schedule/groups\\__pycache__'
# то вам следует закомментировать верхний код и раскоментировать код, который расположен ниже и запустить main.py
# ====================================================================================================================#
#
# import os
# from app.database.models import async_session
...
#         for file in files:
#             file_path = os.path.join(folder_path, file)
#             if file == 'parse.py' or not os.path.isfile(file_path):
#                 continue
#             async with aiofiles.open(file_path, mode='r', encoding='utf-8') as f:
#                 group = await f.readline()
#                 group = group[6:].strip()
